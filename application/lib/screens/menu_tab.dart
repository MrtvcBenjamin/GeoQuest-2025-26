    ...
    return Navigator(
      ...
      onGenerateRoute: (settings) {
        switch (settings.name) {
          case '/menu/settings':
            return MaterialPageRoute(builder: (_) => const _SettingsScreen(), settings: settings);
          case '/menu/privacy':
            return MaterialPageRoute(builder: (_) => const _PrivacyScreen(), settings: settings);
          case '/menu/imprint':
            return MaterialPageRoute(builder: (_) => const _ImprintScreen(), settings: settings);
          case '/menu':
          default:
            return MaterialPageRoute(builder: (_) => const _MenuRootScreen(), settings: settings);
        }
      },
    );
  }
...
class _SettingsScreen extends StatelessWidget {
  ...
  MaterialStateProperty<Color?> _thumbColor(Color on, Color off, Set<MaterialState> states) {
    if (states.contains(MaterialState.selected)) return MaterialStateProperty.all(on);
    return MaterialStateProperty.all(off);
  }

  MaterialStateProperty<Color?> _trackColor(Color on, Color off, Set<MaterialState> states) {
    if (states.contains(MaterialState.selected)) return MaterialStateProperty.all(on);
    return MaterialStateProperty.all(off);
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Einstellungen',
                style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900, height: 1.0, color: onSurface),
              ),
                ...
                builder: (context, mode, _) {
                  ...
                  return Row(
                    children: [
                      Text(
                        'Erscheinungsbild',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: onSurface),
                      ),
                      const Spacer(),
                      Text(
                        isDark ? 'Dunkel' : 'Hell',
                      ...
                      Switch(
                        ...
                        onChanged: (v) async {
                          ...
                          _showSnack(context, v ? 'Dark Mode aktiviert' : 'Light Mode aktiviert');
                        },
                        thumbColor: _thumbColor(activeThumb(), inactiveThumb(), const {}),
                        trackColor: _trackColor(activeTrack(), inactiveTrack(), const {}),
                      ),
                    ],
                  );
                },
                    ...
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: (v) async {
                          ...
                          _showSnack(context, v ? 'Benachrichtigungen an' : 'Benachrichtigungen aus');
                        },
                        thumbColor: _thumbColor(activeThumb(), inactiveThumb(), const {}),
                        trackColor: _trackColor(activeTrack(), inactiveTrack(), const {}),
                      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Verantwortlich\nGeoquest-Team',
                style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w800, height: 1.25, color: onSurface),
              ),
              ...
              Text(
                ...
                style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w700, height: 1.35, color: onSurface),
              ),
              const Spacer(),
            ],
          ),
