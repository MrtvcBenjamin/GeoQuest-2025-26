...
![Splash-Screen](img/screens/01_splash_screen.png){ width=40% }
...
![Rollenwahl](img/screens/03_rollenwahl.png){ width=40% }
...
![Registrierung](img/screens/05_registrierung.png){ width=40% }
...
![Anmeldung](img/screens/04_anmeldung.png){ width=40% }
...
![Admin-Login](img/screens/06_admin_login.png){ width=40% }
...
![Home-Shell](img/screens/07_homeshell.png){ width=40% }
...
![Hunt-Start und Route](img/screens/08_hunt_start.png){ width=40% }
...
![Kartenansicht](img/screens/09_karte.png){ width=40% }
...
![Radiusprüfung und Freigabe](img/screens/11_radius.png){ width=40% }
...
![Fortschritt und Ranking](img/screens/12_Progress.png){ width=40% }
...
![Admin-Karte](img/screens/15_admin_map.png){ width=40% }
...
![Menü und Einstellungen](img/screens/13_menu.png){ width=40% }
...
![Abschlussscreen](img/screens/14_Abschlussscreen.png){ width=40% }
